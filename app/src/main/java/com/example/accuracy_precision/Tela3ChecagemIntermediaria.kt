...
class Tela3ChecagemIntermediaria : AppCompatActivity() {
    ...
    override fun onStart() {
        ...
        advance.setOnClickListener {
            ...
            if (avancar) {
                ...
                var i = Intent(this, Tela4DuplicataEnsaio::class.java)
        ...
        retreat.setOnClickListener {
            ...
            var i = Intent(this, Tela2InformacoesGerais::class.java)
